...
class PacmanGraphics:
    ...
    def initialize(self, state, name, isBlue=False):
        self.isBlue = isBlue
        self.startGraphics(state, name)
    ...
    def startGraphics(self, state, name):
        self.layout = state.layout
        layout = self.layout
        self.width = layout.width
        self.height = layout.height
        self.make_window(self.width, self.height, name)
    ...
    def make_window(self, width, height, name):
